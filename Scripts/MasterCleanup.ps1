# ================================================
# MASTERCLEANUP v2.1 - központi vezérlő
# ================================================
...
Write-Host "          MASTERCLEANUP v2.1 - CleanupTools" -ForegroundColor Green
...
Write-Host "4. Csak NTFS Reset (rejtett foglaltság)"
...
do {
    ...
    switch ($valaszt) {
        "1" { & "$Drive\Scripts\Takarito.ps1"; & "$Drive\Scripts\SVI_Cleanup_v2.ps1"; & "$Drive\Scripts\NTFS_Reset.ps1" }
        "2" { & "$Drive\Scripts\Takarito.ps1" }
        "3" { & "$Drive\Scripts\SVI_Cleanup_v2.ps1" }
